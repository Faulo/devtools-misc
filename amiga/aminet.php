...
require '../../../global/slothsoft.core.php';
require '../../../global/slothsoft.core.xslt.php';
require '../../../global/slothsoft.core.dbms.php';
        ...
        foreach ($packages as $package) {
            ...
            if ($package['skip']) {
                ...
                if (file_exists($package['folder'] . '.info')) {
                    ...
                    $command = sprintf('7z x %s -o%s', escapeshellarg($package['file']), escapeshellarg($package['folder']));
