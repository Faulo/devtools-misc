...
$fix = new TagCommit('devops', "comment = 'Update project files' and owner = 'daniel.schulz@ulisses-spiele.de'"); // and not attribute = 'devops'
$fix->setComment('If set, this changeset was auto-generated by the devops pipeline.');
